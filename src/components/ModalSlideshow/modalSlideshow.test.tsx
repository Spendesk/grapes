...
const slides: ModalSlideshowSlide[] = [
  ...
  },
  {
    ...
    content: <p>Slide content 2</p>,
  },
  {
    title: 'Slide title 3',
    illustration: <img src="https://via.placeholder.com/100x500" alt="" />,
    content: <p>Slide content 3</p>,
  },
];

describe('ModalSlideshow component', () => {
